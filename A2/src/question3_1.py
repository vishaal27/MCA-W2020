...
if __name__ == '__main__':
	...
	# pickle.dump(training_spec_feats, open('./original_train_spectrogram_features.pickle', 'wb'))
	...
	# pickle.dump(val_spec_feats, open('./original_val_spectrogram_features.pickle', 'wb'))
	...
	f = open('./results_spectrogram_original.txt', 'w')
	...
	for c in C_vals:
		for ker in kernels:
			...
			joblib.dump(svm, './svm_original_spectrogram_('+str(c)+', '+str(ker)+').joblib')
