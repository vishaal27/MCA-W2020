...
if __name__ == '__main__':
	...
	# pickle.dump(training_spec_feats, open('./original_train_mfcc_features.pickle', 'wb'))
	...
	# pickle.dump(val_spec_feats, open('./original_val_mfcc_features.pickle', 'wb'))
	...
	f = open('./results_mfcc_original.txt', 'w')
	...
	for c in C_vals:
		for ker in kernels:
			...
			joblib.dump(svm, './svm_original_mfcc_('+str(c)+', '+str(ker)+').joblib')
